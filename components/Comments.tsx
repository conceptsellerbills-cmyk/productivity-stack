...
const SITE_ID = "productivity-stack"
  ...
  return (
    <>
      <style>{`
        ...
        .comments-heading{font-size:0.72rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#10b981;margin-bottom:6px}
        ...
        .comment-avatar{width:32px;height:32px;border-radius:50%;background:linear-gradient(135deg,#10b98155,#10b98122);display:flex;align-items:center;justify-content:center;font-size:0.85rem;font-weight:700;color:#10b981;flex-shrink:0}
        ...
        .comment-name-input:focus,.comment-body-input:focus{border-color:#10b981}
        ...
        .comment-submit{background:#10b981;color:#fff;border:none;border-radius:8px;padding:11px 28px;font-size:0.9rem;font-weight:700;cursor:pointer;transition:opacity 0.15s}
