...
export const metadata: Metadata = { title: "Terms of Use — Productivity Stack", description: "Terms of Use for Productivity Stack (productivity-stack.com)." };
export default function TermsPage() {
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .page-eyebrow{font-size:0.72rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#10b981;margin-bottom:10px}
  ...
  .form-group input:focus,.form-group textarea:focus,.form-group select:focus{border-color:#10b981}
  .form-group input::placeholder,.form-group textarea::placeholder{color:#4b5563}
  .form-submit{background:#10b981;color:#fff;border:none;border-radius:10px;padding:13px 32px;font-size:1rem;font-weight:700;cursor:pointer;align-self:flex-start;transition:opacity 0.15s}
  ...
  .highlight-box{background:rgba(16,185,129,0.08);border:1px solid rgba(16,185,129,0.25);border-radius:12px;padding:24px 28px;margin:28px 0}
...
`}</style>
      <div className="page-wrap">
        ...
        <p>By accessing and using productivity-stack.com, you accept and agree to be bound by these Terms of Use. If you do not agree with any part of these terms, please do not use our website.</p>
        <h2>2. Use of Content</h2>
        <p>All content published on Productivity Stack — including articles, reviews, images, and graphics — is the intellectual property of Productivity Stack unless otherwise stated. You may not reproduce, distribute, or republish our content without prior written permission.</p>
        ...
        <p>Productivity Stack is not liable for any direct, indirect, or consequential damages arising from your use of this website or reliance on information published here.</p>
        ...
        <h2>7. Contact</h2>
        <p>For questions about these Terms of Use, contact us at <a href="mailto:hello@productivity-stack.com">hello@productivity-stack.com</a>.</p>
      </div>
    </>
  );
}
