...
export const metadata: Metadata = { title: "Privacy Policy — Productivity Stack", description: "Privacy Policy for Productivity Stack (productivity-stack.com)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p>Welcome to Productivity Stack ("we", "us", or "our"), accessible at productivity-stack.com. This Privacy Policy explains how we collect, use, and protect your information when you visit our website.</p>
        ...
        <h2>6. Your Rights</h2>
        <p>You have the right to access, correct, or delete your personal data. To exercise these rights, contact us at <a href="mailto:hello@productivity-stack.com">hello@productivity-stack.com</a>.</p>
        ...
        <h2>9. Contact</h2>
        <p>For privacy-related questions, contact us at <a href="mailto:hello@productivity-stack.com">hello@productivity-stack.com</a>.</p>
      </div>
    </>
  );
}
