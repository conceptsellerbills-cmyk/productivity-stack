...
export const metadata: Metadata = { title: "Cookie Policy — Productivity Stack", description: "Cookie Policy for Productivity Stack (productivity-stack.com)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h2>Contact</h2>
        <p>If you have questions about our cookie use, contact us at <a href="mailto:hello@productivity-stack.com">hello@productivity-stack.com</a>.</p>
      </div>
    </>
  );
}
