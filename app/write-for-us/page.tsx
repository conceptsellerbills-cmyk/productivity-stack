...
export const metadata: Metadata = { title: "Write for Us — Productivity Stack", description: "Contribute a guest post to Productivity Stack. Share your expertise on productivity apps and tools." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p className="page-subtitle">We welcome guest contributors who can bring original insights and expertise to our readers. If you know productivity apps and tools well, we'd love to publish your work.</p>
        <hr className="page-divider" />
        <h2>What We're Looking For</h2>
        <ul>
          <li>Original, well-researched articles on productivity apps and tools</li>
        ...
        <h2>How to Pitch</h2>
        <p>Email us at <a href="mailto:hello@productivity-stack.com">hello@productivity-stack.com</a> with the subject line "Guest Post Pitch" and include:</p>
        <ul>
