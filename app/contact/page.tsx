...
export const metadata: Metadata = { title: "Contact — Productivity Stack", description: "Get in touch with the Productivity Stack team." };
...
`}</style>
      <div className="page-wrap">
        ...
        <div className="info-card">
          ...
          <p>For faster responses, email us at <a href="mailto:hello@productivity-stack.com">hello@productivity-stack.com</a>. We reply within 1–2 business days.</p>
        </div>
