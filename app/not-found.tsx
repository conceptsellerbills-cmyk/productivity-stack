...
export default function NotFound() {
  ...
  return (
    <>
      <style>{`
        .nf-wrap{min-height:70vh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:60px 24px;text-align:center;background:#030f09}
        .nf-code{font-size:clamp(5rem,15vw,9rem);font-weight:900;line-height:1;background:linear-gradient(135deg,#10b98155,#10b981);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin-bottom:8px}
        ...
        .nf-btn-primary{background:#10b981;color:#fff;border:none;padding:12px 28px;border-radius:8px;font-size:0.95rem;font-weight:700;cursor:pointer;text-decoration:none;transition:opacity 0.15s}
        ...
        .nf-btn-secondary:hover{border-color:#10b981;color:#10b981}
        ...
        .nf-card:hover{border-color:#10b981;transform:translateY(-2px)}
