...
export const metadata: Metadata = { title: "Advertise — Productivity Stack", description: "Advertise with Productivity Stack and reach a targeted audience interested in productivity apps and tools." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h1 className="page-title">Advertise on Productivity Stack</h1>
        <p className="page-subtitle">Reach a highly engaged audience of readers actively researching and comparing productivity apps and tools. Our visitors are decision-ready — they come here to find the best options.</p>
        ...
        <h2>Get in Touch</h2>
        <p>For pricing, media kit, and availability, contact us at <a href="mailto:hello@productivity-stack.com">hello@productivity-stack.com</a> with the subject line "Advertising Inquiry". We'll respond within 2 business days.</p>
      </div>
    </>
  );
}
